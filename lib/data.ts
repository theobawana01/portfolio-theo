...
const profile: Profile = {
  ...
  website: 'https://portfolio-theo-rho.vercel.app/',
...
const projects: Project[] = [
  {
    ...
    github_url: 'https://github.com/theobaw01/htr-math',
    demo_url: '',
    image: null,
    featured: false,
  ...
  },
  {
    ...
    category: 'ia',
    status: 'completed',
    short_description: "Projet personnel de vérification d'identité par OCR et reconnaissance d'image — adopté et déployé en pré_production",
  ...
  },
  {
    ...
    github_url: 'https://github.com/theobaw01/ECommerce-IA',
    demo_url: '',
    image: null,
    featured: false,
    is_confidential: false,
  ...
  {
    id: 5,
    title: 'Prévision de la consommation énergétique',
    slug: 'prediction-energie',
    category: 'data',
    status: 'completed',
    short_description: 'Projet personnel de modélisation prédictive et BI pour anticiper les trajectoires énergétiques',
    full_description: "Architecture de régression hybride (Stacking Regressor) entraînée sur 33 ans d'indicateurs macroéconomiques de la Banque Mondiale. Le modèle est intégré dans une application web avec tableaux de bord dynamiques pour analyser et projeter la consommation énergétique.",
    highlights: [
      ...
      'Analyse des trajectoires énergétiques',
    ...
    metrics: { period: '33 ans', status: 'Prototype en test' },
    github_url: '',
  ...
  },
  {
    ...
    metrics: {},
    github_url: '',
    demo_url: 'https://youtu.be/Kp28wMEsXS0',
    image: null,
    featured: true,
    is_confidential: false,
    order: 3,
